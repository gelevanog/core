...
export type Expression = LiteralExpr | RefExpr | MemberExpr | IndexExpr | BinaryExpr | UnaryExpr | CallExpr | MethodExpr | TernaryExpr | ObjectExpr | ArrayExpr | string | number | boolean;
...
export type Statement = LetStmt | SetStmt | IfStmt | ForStmt | WhileStmt | ReturnStmt;
